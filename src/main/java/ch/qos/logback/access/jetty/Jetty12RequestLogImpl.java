...
import ch.qos.logback.access.spi.Jetty12AccessEvent;
 ...
 */
public class Jetty12RequestLogImpl extends ContextBase implements LifeCycle, RequestLog, AppenderAttachable<IAccessEvent>, FilterAttachable<IAccessEvent> {
    ...
    public void log(Request jettyRequest, Response jettyResponse) {
        ...
        IAccessEvent accessEvent = new Jetty12AccessEvent(this, jettyRequest, jettyResponse, adapter);
    ...
    private JettyServerAdapter makeJettyServerAdapter(Request jettyRequest, Response jettyResponse) {
       return new Jetty12ServerAdapter(jettyRequest, jettyResponse);
    }
